...
student_notification.user_id, 
student_notification.message, 
student_notification.created_at, 
student_notification.read_status
FROM
student_notification
WHERE
student_notification.user_id = '$user_id'
ORDER BY
student_notification.created_at DESC
LIMIT 5";
...
<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
        <?php if ($row['read_status'] == 0) : ?>
            ...
            $update_query = "UPDATE `student_notification` SET `read_status` = 1 WHERE `id` = " . $row['id'];
