                ...
                <div class="card-body">
                  ...
                  <?php 
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted font-size-sm"><?= $user['barangay']; ?> , <?= $user['municipality']; ?></p>
                      <a class="btn btn-primary" onclick="location.href='message.php?id=<?= $user['user_id']; ?>'" style="cursor: pointer;">Message</a>
                    </div>
                  </div>
                </div>
              </div>
...
<div class="card h-500">
    <div class="card-body">
        <h6 class="d-flex align-items-center mb-3"><u>Recent Review</u></h6>
        <?php
    ...
    FROM
        ...
        tutorial_services
        ON 
            tutorial_services_review.job_id = tutorial_services.job_id
    WHERE
        tutorial_services.tutor_id = '$id'
    ORDER BY
    ...
    LIMIT 5";
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            // Convert stars to star symbols
            $stars = "";
            for ($i = 0; $i < $row['stars']; $i++) {
                $stars .= "★";
            }
        
            // Display the review with star symbols
            
            echo "<p>Rate: " . $stars . "</p>";

            echo "<p>Comment: " . $row['comment'] . " <hr></p>";
        } else {
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><u>Recent Tutorial Services</u></h6>
                      <?php
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6 class="d-flex align-items-center mb-3"><u>Recent Module</u></h6>
                      <?php
                    ...
                    WHERE
                        tutorial_services.tutor_id = '$id'
                    ORDER BY
                        tutorial_module.module_posted DESC
                    LIMIT 5";
                     ...
                     $module_title = $row['module_title'];
                            echo "<p>Title: " . $module_title . " <hr></p>";
