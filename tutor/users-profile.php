            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <h5 class="card-title">About me</h5>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Educational Attainment</div>
                    <div class="col-lg-9 col-md-8"><?= $user['educational']; ?></div>
                  </div>

                  <h5 class="card-title">Recent Review</h5>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <div class="row mb-3">
                  <label for="aboutme" class="col-md-4 col-lg-3 col-form-label">About Me</label>
                  <div class="col-md-8 col-lg-9">
                  <textarea class="form-control" id="aboutme" name="aboutme" rows="4"><?= $user['aboutme']; ?></textarea>
                  </div>
                  </div>
