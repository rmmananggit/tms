...
$query = "SELECT
tutor_notification.id, 
tutor_notification.user_id, 
tutor_notification.message, 
tutor_notification.created_at, 
tutor_notification.read_status
FROM
tutor_notification
WHERE
tutor_notification.user_id = '$user_id'
ORDER BY
tutor_notification.created_at DESC
LIMIT 5";
...
<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
    ...
    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
        <?php if ($row['read_status'] == 0) : ?>
            ...
            $update_query = "UPDATE `tutor_notification` SET `read_status` = 1 WHERE `id` = " . $row['id'];
