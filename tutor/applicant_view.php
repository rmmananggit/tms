...
<div class="row">
    ...
    <form action="process.php" method="POST">
        ...
        <?php if ($user['applicationStatus'] != 'Ongoing' && $user['applicationStatus'] != 'Rejected' && $user['paymentStatus'] != 'Paid') { ?>
...
<?php } elseif (($user['applicationStatus'] == 'Ongoing' || $user['applicationStatus'] == 'Rejected') && $user['paymentStatus'] != 'Paid') { ?>
    <form action="process.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="application_id" value="<?= $user['application_id']; ?>">
        <input type="hidden" name="student_user_id" value="<?=$user['user_id'];?>">
         <input type="hidden" name="title" value="<?=$user['title'];?>">
        <button type="submit" name="unlockmodule" class="btn btn-success" style="float:right; margin-left: 10px;">Unlock Module</button>
    </form>
<?php } ?>
