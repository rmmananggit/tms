...
<body>
  ...
  <div class="container h-100 mt-5">
    <div class="row align-items-center h-100" style="margin-bottom:90px;">
      <div class="col-md-12 mx-auto">
        <div class="text-center col-md-12">
          <img src="./assets-landingpage/img/logopic.png" style="height: 400px; width:fit-content;" alt="Logo" class="logo img-fluid mb-3">
          <h1 class="welcome-text mb-3 text-center">TEACH ME SENSEI - Tutoring System</h1>
          <p class="description-text">Seamlessly connect tutors and students for personalized education</p>
          <a class="btn btn-outline-danger btn-lg" role="button" href="./login/student_login.php" aria-disabled="true">Login as Student</a>
          <a class="btn btn-outline-primary btn-lg" role="button" href="./login/tutor_login.php" aria-disabled="true">Login as Tutor</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">TMS TEAM</a>
      </div>
    </div>
  </footer><!-- End Footer -->
