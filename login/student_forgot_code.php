...
if (isset($_POST['forgot'])) {
    ...
    if (!$email) {
        ...
        header("Location: student_forgot.php");
        exit;
    }
    ...
    if ($result->num_rows > 0) {
        ...
        $mail->Subject = "Student Forgot Password OTP";
        ...
        header("Location: student_forgot_otp.php");
        exit;
    } else {
        header("Location: student_forgot_otp.php");
        exit;
...
if (isset($_POST['forgot_otp'])) {
    ...
    $sql = "SELECT * FROM student WHERE email = ? AND otp = ?";
    $stmt = $con->prepare($sql);
    ...
    if ($result->num_rows > 0) {
        ...
        $mail->Subject = "Student New Password";
