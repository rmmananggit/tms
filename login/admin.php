...
<body>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form action="login_admin.php" method="POST" autocomplete="off" novalidate>
                ...
                <button type="submit" class="btn btn-primary btn-block" name="adminlogin" onclick="validateForm()">Sign In</button>

                <div class="text-center mt-3">
                    <p>Don't have an account? <a href="../register/index.php">Create an account</a></p>
                </div>
            </form>
        </div>
    </div>
