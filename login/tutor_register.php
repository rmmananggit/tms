    ...
    <div class="container">
            ...
            <div class="col-lg-8 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Create an Tutor Account</h5>
                    <p class="text-center small">Enter your personal details to create account</p>
                  </div>

                  <form action="tutor_register_code.php" method="POST" enctype="multipart/form-data" autocomplete="off"  class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-6 mt-2">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12 mt-2">
                      <label for="aboutme" class="form-label">About me <small style="color: red;">*</small></label>
                      <textarea name="aboutme" class="form-control" id="aboutme" placeholder="Eg. I am confidently beautiful with a heart" required></textarea>
                  </div>

                  <div class="col-md-12 mt-2">
                    <label for="resume" class="form-label">Resume <small style="color: red;">*</small></label>
                ...
                <div class="col-md-12 mt-2">
                  ...
                  <input type="file" name="profilepicture" class="form-control" id="profilepicture" accept="image/*" required>
               </div>
     ...
     <div class="col-md-6 form-group">
       ...
       <div class="captcha"><?php echo $rand; ?></div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have an account? <a href="../login/tutor_login.php">Log in</a></p>
                    </div>
                  </form>
