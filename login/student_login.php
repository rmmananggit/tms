...
<body>
    ...
    <div class="container">
        <div class="login-container">
            ...
            <form action="login_student.php" method="POST" autocomplete="off" novalidate>
                ...
                <div class="form-group">
                    <div class="forgot-password">
                        <a href="student_forgot.php">Forgot Password?</a>
                    </div>
                </div>

                <button type="submit" class="btn btn-primary btn-block" name="studentlogin" onclick="validateForm()">Sign In</button>

                <div class="text-center mt-3">
                    <p>Don't have an account? <a href="student_register.php">Create an account</a></p>
                </div>
            </form>
        </div>
    </div>
